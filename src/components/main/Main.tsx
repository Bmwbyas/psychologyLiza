            ...
            <div className='flex items-center '>
                ...
                <div className=' my-2 text-gray-400 leading-relaxed  text-base pl-5'>
                    ...
                    <p>
                        ...
                        заболеваниями» и в Институте гуманистической и экзистенциальной психологии (Вильнюс-Бирштонас).
                    </p>
                    <p>
                    ...
                    Сертифицированный парный терапевт по методу Джона Готтмана (The Gottman Institute) и это значит, что
                    я
                    могу работать с запросами в паре.
                </div>
            </div>
